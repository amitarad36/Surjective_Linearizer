...
def get_celeba_data_loaders(train_bs, val_bs, target_size, use_ddp=False, world_size=1, rank=0):
    ...
    train_dataset = datasets.CelebA(root='~/datasets', split='train', download=True, transform=train_transform)
    val_dataset = datasets.CelebA(root='~/datasets', split='valid', download=True, transform=test_transform)
